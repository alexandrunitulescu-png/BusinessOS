    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-4">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h2 className="text-sm font-semibold text-slate-900">ANAF e-Factura</h2>
        ...
        <button
          ...
          className="mt-4 inline-flex cursor-not-allowed items-center rounded-md bg-slate-900 px-3.5 py-2 text-sm font-medium text-white opacity-50"
        >
          Conectează la ANAF
        </button>
